...
from bmu.models import Device, DeviceGroup, JobKind, Profile, Run, RunStatus, Schedule
from bmu.queue import ensure_consumer_group, publish_job
...
def _spec_for(device: Device, profile: Profile, run: Run, kind: JobKind,
    ...
    return JobSpec(
        ...
        disable_paging_command=profile.disable_paging_command,
